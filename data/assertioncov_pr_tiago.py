...
for ii in range(10,51):
	for num,line in enumerate(open(os.getcwd()+'/data_diffseeds_tiago_pr/assertion1_'+str(ii)+'.txt','r')): 
...
result=[]
for ii in range(10,51):
	for num,line in enumerate(open(os.getcwd()+'/data_diffseeds_tiago_pr/assertion2_'+str(ii)+'.txt','r')): 
		getdata = re.split("Assertion 1 at test",line)
		gettest = re.split("[:]",getdata[1]) #test at 0
		getporf = re.split("at global time",gettest[1])
		if len(checked)<1:
...
result=[]
for ii in range(10,51):
	for num,line in enumerate(open(os.getcwd()+'/data_diffseeds_tiago_pr/assertion3_'+str(ii)+'.txt','r')): 
...
result=[]
for ii in range(10,51):
	for num,line in enumerate(open(os.getcwd()+'/data_diffseeds_tiago_pr/assertion4_'+str(ii)+'.txt','r')): 
		getdata = re.split("Assertion 4 at test",line)
		gettest = re.split("[:]",getdata[1]) #test at 0
		getporf = re.split("at global time",gettest[1])
		if len(checked)<1:
