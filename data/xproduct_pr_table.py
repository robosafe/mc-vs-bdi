...
for jj in range(10,51):
	for i in range(1,161):
		...
		badlegs = 0
		to2 = 0
		for num,line in enumerate(open(os.getcwd()+'/data_diffseeds_table_pr/seed'+str(jj)+'/robotout'+str(i),'r')): 
		...
		bored = 0
		activ2 = 0
		for num,line in enumerate(open(os.getcwd()+'/data_diffseeds_table_pr/seed'+str(jj)+'/humanout'+str(i),'r')): 
