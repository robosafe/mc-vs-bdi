...
for num,line in enumerate(open(open(os.getcwd()+'/results/results_tiago/bdi_logs/assertion1.txt','r')): 
...
for num,line in enumerate(open(os.getcwd()+'/results/results_tiago/bdi_logs/assertion2.txt','r')): 
	getdata = re.split("Assertion 1 at test",line)
	gettest = re.split("[:]",getdata[1]) #test at 0
	getporf = re.split("at global time",gettest[1])
	if len(checked)<1:
...
for num,line in enumerate(open(os.getcwd()+'/results/results_tiago/bdi_logs/assertion3.txt','r')): 
...
for num,line in enumerate(open(os.getcwd()+'/results/results_tiago/bdi_logs/assertion4.txt','r')): 
	getdata = re.split("Assertion 4 at test",line)
	gettest = re.split("[:]",getdata[1]) #test at 0
	getporf = re.split("at global time",gettest[1])
	if len(checked)<1:
