...
for num,line in enumerate(open(os.getcwd()+'/results/results_table/bdi_logs/assertion1.txt','r')): 
...
for num,line in enumerate(open(os.getcwd()+'/results/results_table/bdi_logs/assertion2.txt','r')): 
...
for num,line in enumerate(open(os.getcwd()+'/results/results_table/bdi_logs/assertion3.txt','r')): 
...
for num,line in enumerate(open(os.getcwd()+'/results/results_table/bdi_logs/assertion4.txt','r')): 
...
for num,line in enumerate(open(os.getcwd()+'/results/results_table/bdi_logs/assertion5.txt','r')): 
...
for num,line in enumerate(open(os.getcwd()+'/results/results_table/bdi_logs/assertion6.txt','r')): 
