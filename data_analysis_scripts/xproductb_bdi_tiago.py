...
for i in range(1,51):
	...
	idl = 0
	finished = 0
	for num,line in enumerate(open(os.getcwd()+'/results/results_tiago/bdi_logs/log_files/robot'+str(i),'r')): 
	...
	hclean = 0
	hother = 0
	for num,line in enumerate(open(os.getcwd()+'/results/results_tiago/bdi_logs/log_files/human'+str(i),'r')): 
