...
for ii in range(10,51):
	for num,line in enumerate(open(os.getcwd()+'/data_diffseeds_table_mc/assertion1_'+str(ii)+'.txt','r')): 
...
result=[]
for ii in range(10,51):
	for num,line in enumerate(open(os.getcwd()+'/data_diffseeds_table_mc/assertion2_'+str(ii)+'.txt','r')): 
...
result=[]
for ii in range(10,51):
	for num,line in enumerate(open(os.getcwd()+'/data_diffseeds_table_mc/assertion3_'+str(ii)+'.txt','r')):
...
for ii in range(10,51):
	for num,line in enumerate(open(os.getcwd()+'/data_diffseeds_table_mc/assertion4_'+str(ii)+'.txt','r')):
...
result=[]
for ii in range(10,51):
	for num,line in enumerate(open(os.getcwd()+'/data_diffseeds_table_mc/assertion5_'+str(ii)+'.txt','r')):
...
result=[]
for ii in range(10,51):
	for num,line in enumerate(open(os.getcwd()+'/data_diffseeds_table_mc/assertion6_'+str(ii)+'.txt','r')):
