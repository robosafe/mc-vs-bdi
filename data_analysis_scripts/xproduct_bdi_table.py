...
for i in range(1,161):
	...
	badlegs = 0
	to2 = 0
	for num,line in enumerate(open(os.getcwd()+'/results/results_table/bdi_logs/log_files/robotout'+str(i),'r')): 
	...
	bored = 0
	activ2 = 0
	for num,line in enumerate(open(os.getcwd()+'/results/results_table/bdi_logs/log_files/humanout'+str(i),'r')): 
