...
for ii in range(10,51):
	for num,line in enumerate(open(os.getcwd()+'/data_diffseeds_table_bdi/assertion1_'+str(ii)+'.txt','r')): 
...
result=[]
for ii in range(10,51):
	for num,line in enumerate(open(os.getcwd()+'/data_diffseeds_table_bdi/assertion2_'+str(ii)+'.txt','r')): 
...
result=[]
for ii in range(10,51):
	for num,line in enumerate(open(os.getcwd()+'/data_diffseeds_table_bdi/assertion3_'+str(ii)+'.txt','r')):
...
for ii in range(10,51):
	for num,line in enumerate(open('/home/da13683/temporary/data_diffseeds_table_bdi/assertion4_'+str(ii)+'.txt','r')):
...
result=[]
for ii in range(10,51):
	for num,line in enumerate(open(os.getcwd()+'/data_diffseeds_table_bdi/assertion5_'+str(ii)+'.txt','r')):
...
result=[]
for ii in range(10,51):
	for num,line in enumerate(open(os.getcwd()+'/data_diffseeds_table_bdi/assertion6_'+str(ii)+'.txt','r')):
